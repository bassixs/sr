      ...
      <section className="section section-muted">
        <div className="container">
          <SectionIntro
            ...
            text="До поездки можно заранее представить территорию, лечебные кабинеты, бассейн, номера, столовую и места, где удобно отдыхать между процедурами."
          />
      ...
      <section className="section section-muted">
        <div className="container">
          <SectionIntro
            ...
            text="На территории есть зоны для лечения, питания, движения, отдыха и семейного пребывания, чтобы день был понятным и без лишней суеты."
          />
      ...
      <section className="section section-muted">
        <div className="container">
          <SectionIntro
            ...
            text="Для звонка, письма, официального обращения и маршрута могут понадобиться разные данные — они разделены, чтобы вы выбрали нужный вариант."
          />
      ...
      <section className="section section-muted">
        <div className="container customer-zone">
          <SectionIntro
            ...
            text="Для финальной публикации нужно подтвердить режим работы, точный маршрут, разделение телефонов по задачам и порядок приема обращений."
          />
