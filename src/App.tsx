...
const footerNavigation = [
  ...
  {
    title: 'Поездка',
    paths: ['/stay', '/prepare', '/prices', '/contacts'],
  },
  {
    title: 'Официально',
...
const routeDescriptions: Record<string, string> = {
  '/': 'Калужский санаторий Звездный: лечение, процедуры, врачи, проживание, цены, документы и официальная информация для гостей.',
  ...
  '/prices': 'Цены, путевки и график заездов санатория Звездный: прейскурант, платные услуги и официальные документы.',
  ...
  '/contacts': 'Контактные данные и адреса Калужского санатория Звездный, а также быстрые ссылки на документы и правила для гостей.',
  ...
  return (
    <>
      <PageHero
        ...
        title="Как устроено медицинское сопровождение во время курса"
        text="Справочная информация о ролях специалистов и порядке медицинского сопровождения во время санаторного курса."
      ...
      <section className="section">
        <div className="container">
          <SectionIntro
            ...
            text="Ниже описаны типовые задачи специалистов. Фактический состав персонала и график работы публикуются учреждением отдельно."
          />
      ...
      <section className="section section-muted">
        <div className="container">
          <SectionIntro
            ...
            title="Типовой маршрут медицинского сопровождения"
            text="Маршрут показывает общую логику курса: первичный прием, назначения, процедуры и рекомендации по его завершении."
          />
      ...
      <section className="section">
        <div className="container">
          <SectionIntro
            eyebrow="Команда"
            title="Что делают специалисты"
            text="Распределение задач зависит от программы, состояния гостя и назначений врача."
          />
      ...
      <section className="section section-muted">
        <div className="container">
          <SectionIntro
            ...
            title="Что происходит на приеме"
            text="Порядок приема и состав документов зависят от программы и определяются учреждением при оформлении путевки."
          />
      ...
      <section className="section">
        <div className="container split-layout">
          <SectionIntro
            ...
            title="Как устроен прием"
            text="Порядок первичного и повторного приема зависит от программы лечения и определяется врачом во время курса."
          />
...
function PricesPage() {
  return (
    <>
      <PageHero
        eyebrow="Цены и программы"
        title="Путевки, платные услуги и график заездов"
        text="Здесь собраны официальный прейскурант, график заездов и основные сведения о платных услугах санатория."
        image={getHref('/media/gallery/lobby/05.webp')}
      />
      <section className="section">
        <div className="container two-panels">
          <article data-animate>
            <span className="eyebrow">Путевки</span>
            <h2>Формат пребывания и стоимость</h2>
            <p>
              Выберите подходящий формат: санаторно-курортное лечение с проживанием, семейное
              оздоровление, курсовку или тур выходного дня.
            </p>
            <p>
              Состав услуг и стоимость зависят от выбранной программы, длительности заезда и назначений врача.
            </p>
          </article>
      ...
      <section className="section">
        <div className="container">
          <SectionIntro
            ...
            title="Маршрут до санатория"
            text="Для маршрута используйте опубликованный адрес медицинской деятельности и актуальные данные навигатора."
          />
      ...
      <section className="section">
        <div className="container">
          <SectionIntro
            ...
            text="Рядом с контактами доступны документы, правила заезда, цены и правовые разделы."
          />
          <div className="contact-link-grid">
            {[
              { label: 'Документы', path: '/official' },
              { label: 'Перед заездом', path: '/prepare' },
              { label: 'Цены и программы', path: '/prices' },
              { label: 'Конфиденциальность сайта', path: '/privacy' },
