  ...
  return (
    <>
      ...
      <section className="section">
        <div className="container split-layout">
          <SectionIntro
            ...
            text="Здесь собраны особенности, которые формируют санаторный опыт: природная среда, врачебное сопровождение, понятный режим и инфраструктура для восстановления."
          />
          <div>
      ...
      <section className="section section-muted">
        <div className="container">
          <SectionIntro
            eyebrow="Территория и пространство"
            title="Визуальный маршрут по санаторию"
            text="Гостю важно заранее представить место: лесную территорию, лечебные кабинеты, бассейн, номера, столовую и спокойные зоны отдыха."
          />
          <div className="future-gallery-grid">
            {['Территория и прогулочные маршруты', 'Лечебные кабинеты и процедуры', 'Номера и бытовые условия', 'Столовая и зоны отдыха'].map((item, index) => (
              <article key={item} data-animate style={getDelay(index)}>
                ...
                <h3>{item}</h3>
                <p>Здесь будет изображение с короткой подписью, чтобы человек быстро понял, как выглядит пространство и для чего оно нужно.</p>
              </article>
            ))}
          </div>
          <EditorialNote>
            Вопрос заказчику: какие зоны можно показывать публично и какие фото считать эталонными? Решение: после отбора фото заменить эти карточки на галерею с реальными или сгенерированными изображениями.
          </EditorialNote>
        </div>
      </section>
      <section className="section section-muted">
        <div className="container">
          ...
          <EditorialNote>
            Вопрос заказчику: подтвердить названия зон, список объектов инфраструктуры и разрешенные к публикации фото. Решение: оставить только подтвержденные объекты и добавить визуальные карточки.
          </EditorialNote>
        </div>
      </section>
    </>
      ...
      <section className="section">
        <div className="container split-layout">
          <SectionIntro
            ...
            text="Этот раздел подготовлен под полноценные карточки врачей: после подтверждения данных посетитель увидит специализацию, опыт, квалификацию и порядок приема."
          />
      ...
      <section className="section section-muted">
        <div className="container">
          <SectionIntro
            ...
            text="В финальной версии здесь останутся только подтвержденные публичные сведения о специалистах."
          />
  ...
  return (
    <>
      <PageHero
        ...
        text="Здесь собраны простые вопросы гостя: где жить, как кормят, что есть для детей и чем заняться после процедур."
        image={roomImage}
      />
      <section className="section">
        <div className="container">
          <SectionIntro
            ...
            text="Страница показывает не гостиничную витрину, а условия жизни во время курса лечения: ритм дня, питание, номера и отдых между назначениями."
          />
  ...
  return (
    <>
      <PageHero
        ...
        text="Раздел помогает различать помощь по государственным гарантиям, платные услуги, курсовки и проживание."
        image={documentsImage}
      />
      <section className="section">
        <div className="container two-panels">
          <article data-animate>
            ...
            <p>
              В финальной версии здесь появится простой порядок действий: кто может получить
      ...
      <section className="section section-muted">
        <div className="container">
          <SectionIntro
            ...
            text="Проверяющий и гость быстро видят название, реквизиты, адреса, контакты, руководителя и режим работы без открытия PDF."
          />
      ...
      <section className="section section-muted">
        <div className="container">
          <SectionIntro
            ...
            text="Файлы подключены к сайту и открываются из раздела документов, чтобы посетитель мог свериться с первоисточником."
          />
    ...
    <>
      ...
      <section className="section section-muted">
        <div className="container">
          <SectionIntro
            eyebrow="Реквизиты"
            title="Контакты и адреса разделены по смыслу"
      ...
      <section className="section">
        <div className="container">
          <SectionIntro
            ...
            title="Маршрут появится после подтверждения"
            text="Чтобы посетитель не ошибся с дорогой, на сайте нужен один согласованный адрес для навигатора и понятная схема проезда."
          />
      ...
      <section className="section">
        <div className="container">
          <SectionIntro
            ...
            text="Контактная страница помогает не только написать письмо, но и сразу найти официальную информацию."
          />
